...
def calculate_relations(basedir, prefix):
    # LOAD NETWORK
    filename = "{basedir}/collider_networks/{prefix}_graphcache2.pkl".format(basedir=basedir, prefix=prefix)
    ...
    print "Total nodes readed: ", len(data_list)

    data_index_nodes = set([x.id for x in data_list])
